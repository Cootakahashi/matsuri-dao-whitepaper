...
sidebar_position: 7
id: roadmap
title: 🗓️ Køreplan og team
description: "Trefaset køreplan fra ¥1 mia. til ¥10 mia. AUM, progressiv DAO-overgang og teamet, der bygger Japans Kultur-OS."
---
...
graph LR
    subgraph "Skabere"
        S1["🏺 Lokale håndværkere\nTraditionelt håndværk"]
        S2["🍵 Regionale producenter\nLokale specialiteter"]
        S3["🎌 GCF-partnere\nKuraterede oplevelser"]
    end
    subgraph "On-chain afregning"
        SC["⚡ Smart contract\nAutomatisk omsætningsopdeling"]
    end
    subgraph "Værdifordeling"
        V1["💎 MTC-tilbagekøb\n(% af hvert salg)"]
        V2["🏘️ Fællesskabsfond\n(Lokal geninvestering)"]
        V3["👤 Skaberindtægt\n(Direkte udbetaling)"]
    end
    S1 & S2 & S3 --> SC
    SC --> V1 & V2 & V3
...
<div style={{display: 'flex', gap: '1.5rem', justifyContent: 'center', flexWrap: 'wrap', margin: '1.5rem 0'}}>
  <img src="/img/events/tour-kagura-guide.jpg" alt="Ko Takahashi guiding a tour" style={{width: '100%', maxWidth: '480px', borderRadius: '12px', boxShadow: '0 8px 32px rgba(0,0,0,0.4)'}} />
</div>
...
![Grundlæggervision — stående ved broen mellem kultur og teknologi](/production/05-roadmap_founder-vision_bridge.jpeg)
...
![Fremtidsvision — Matsuri-økonomien ekspanderer over hele kloden](/production/05-roadmap_future-vision_global-adoption.jpg)
