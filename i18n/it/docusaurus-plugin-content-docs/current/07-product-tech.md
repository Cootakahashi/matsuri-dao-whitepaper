...
| **Matsuri** | App consumer principale | 🔜 Inizio maggio 2026 | 🇯🇵🇬🇧🇨🇳🇹🇭🇳🇴 |
...
:::info Stato: uscita prevista a inizio maggio 2026 (v3.0)
L'app principale per gli utenti normali. Prenotazione eventi, pagamento, wallet Web3, AR mining — tutto si conclude in un'unica app.
:::
