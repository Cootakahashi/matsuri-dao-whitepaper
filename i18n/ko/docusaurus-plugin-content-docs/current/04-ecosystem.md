...
![마이닝의 5대 축 — 인간의 행동이 디지털 골드를 만든다](/production/04-ecosystem_mining-pillars_labeled.jpg)
...
GPS와 토큰 인센티브를 활용해 물리적인 '사람의 흐름'을 제어하는 차세대 기능입니다. 성지 맵은 Matsuri App에서 **이미 가동 중** — 온체인 보상 분배는 스마트 컨트랙트 배포와 함께 시작됩니다.
...
콘텐츠를 소비하는 것에 그치지 않고, Matsuri 플랫폼에서는 **누구나** 제작하고 수익화할 수 있습니다.

| 플랫폼 | 크리에이터가 하는 일 | 수익 모델 |
| :--- | :--- | :--- |
| **📚 코스 마켓플레이스** | 일본 문화·언어·공예에 관한 동영상/텍스트 코스 게시 | 수강 건당 수수료 (크리에이터 수익 분배) |
| **🎙️ 팟캐스트 스튜디오** | Spotify, Apple Podcasts, RSS 배포 오디오 시리즈 제작 | 구독 한정 에피소드 |
| **🤝 크라우드펀딩** | 문화 프로젝트를 위한 Solana 기반 모금 캠페인 론칭 | 온체인 기여 추적 |
| **🛍️ 유저 숍** | 플랫폼 내 개인 숍 개설 (공예품, 굿즈) | 상품/리뷰 시스템 기반 직접 판매 |

:::tip AI 기반 제작 지원
이벤트 호스트는 **내장 AI 어시스턴트 (GPT-4 Turbo)**를 사용해 이벤트 설명 작성, 5개 언어 자동 번역, SEO 최적화 메타데이터 생성을 관리 대시보드 내에서 수행할 수 있습니다.
:::
...
| **목표 APY** | **20%** (리스크 프리미엄 설정) |
| **의의** | 생태계 초기 유동성을 확보하여 안정적 거래 환경 구축 |

---

**[▶ 다음: MTC 획득 및 사용 방법](/docs/how-to-earn)** ｜ **[◀ 이전: 경제 시스템](/docs/economy)**
