...
MTC अनुमानमूलक टोकन होइन। यो वास्तविक अर्थतन्त्रमार्फत परिक्रमण गर्छ जहाँ हरेक कार्यले मूल्य उत्पादन गर्छ र समात्छ। वेब एप्लिकेसन र एड्मिन ड्यासबोर्ड **पहिले नै लाइभ छन्**। योगदान स्कोरहरू हाल अफ-चेन (Django मा) रेकर्ड गरिन्छन् र **अडिट-गेटेड चरणहरू** मा अन-चेनमा सर्नेछन् — प्रत्येक contract आफ्नो सुरक्षा अडिट पास गरेपछि मात्र mainnet मा जान्छ (तल [अन-चेन माइग्रेशन रोडम्याप](#on-chain-migration-roadmap) हेर्नुहोस्)।
...
5. पछिको अडिट गरिएको चरणमा: प्रमाणित स्कोरहरू oracle मार्फत अन-चेन रेकर्ड हुन्छन् र ब्लकचेनमा प्रमाणित गर्न योग्य बन्छन्

---

### 2. ⛩️ साहसिक खनन (हिँड्नुहोस् र कमाउनुहोस्)

**परियोजना "Junrei" — smart-contract डिजाइन पूरा; mainnet तैनाथी पछिको अडिट गरिएको चरणमा (Phase 1 buyback contract पछि)**

![पवित्र स्थलमा रात — मौनतामा, omikuji प्रकाश बन्छ](/brand/07_A_night_shrine.webp)

GPS र टोकन प्रोत्साहनहरू प्रयोग गरेर भौतिक "मानिसहरूको प्रवाह" आकार दिने अर्को-पुस्ताको सुविधा। पवित्र-स्थल नक्सा Matsuri वेब एपमा **पहिले नै लाइभ** छ। योगदान स्कोरहरू हाल अफ-चेन रेकर्ड गरिन्छन्; अन-चेन पुरस्कार वितरण यस contract को अडिट गरिएको mainnet तैनाथीपछि पछिको चरणमा सुरु हुन्छ।
...
sequenceDiagram
    ...
    participant SC as Solana (पछिको अडिट गरिएको चरण)
    ...
    API->>SC: Solana मा पुश (असिङ्क्रोनस, पछिको चरण)
```
...
:::warning हाल अफ-चेन → पछिको अडिट गरिएको चरणमा अन-चेनमा माइग्रेट
रेफरल कमिशनहरू हाल Django (PostgreSQL) मा ट्र्याक गरिन्छन् र बैंक स्थानान्तरण वा क्रिप्टोद्वारा भुक्तानी गरिन्छ। पछिको चरणमा — आफ्नै सुरक्षा अडिट पास गरेपछि — उनीहरू Solana मा **Matsuri Referral स्मार्ट कन्ट्र्याक्ट** मा सर्छन्, अन-चेन, अडिट योग्य भुक्तानी ल्याउँछन्। (पहिलो अडिट गरिएको अन-चेन contract `matsuri-buyback` हो; [माइग्रेशन रोडम्याप](#on-chain-migration-roadmap) हेर्नुहोस्।)
:::
...
| **📈 Toku staking** | तपाईंको योगदान स्कोर बूस्ट गर्न MTC लक गर्नुहोस् (~50% सम्म बूस्ट) | 🔜 पछिको चरण |
...
:::info अडिट-चरणबद्ध rollout — पहिले के तैनाथ हुन्छ
माइग्रेशन एक **चरणबद्ध सुरक्षा अडिट (Hashlock)** द्वारा नियन्त्रित छ, त्यसैले क्रम कुनै निश्चित पात्रोले होइन, अडिटहरूले निर्धारण गर्छन्:

- **`matsuri-buyback`** (राजस्व → स्वचालित MTC buy-back) अन-चेन जाने **पहिलो** contract हो — 2026 मा अडिट गरिएको (Phase 1), Raydium सूचीकरणपछि तैनाथ।
- **`matsuri-vesting`** (550M halving-release पूल) लगभग **2027-06-01 Grand Unlock** (Phase 1.5) मा, `matsuri-distribution` सँगै आउँछ।
- तलका **mining contracts** (referral / adventure / omikuji) **पछिका चरणहरू** हुन्, प्रत्येक आफ्नो अडिट पास गरेपछि मात्र तैनाथ हुन्छ।

तलको तालिकामा product-phase संख्याहरूले rollout को दृष्टि वर्णन गर्छन्; तिनका मितिहरू यस अडिट तालिकाको पछाडि क्रमित छन्।
:::
...
graph LR
    ...
    subgraph "पहिलो अन-चेन (2026, अडिट-पछि)"
        H0["💱 राजस्व buyback → अन-चेन\n(matsuri-buyback contract)"]
    end
    subgraph "पछिका अडिट गरिएका चरणहरू (हाइब्रिड)"
    ...
    O1 & O2 & O3 & O4 -->|"माइग्रेट (अडिट गरिएको)"| H0
    H0 --> H1 & H2 & H3 & H4
...
| **चरण 2 (2026, अडिट-गेटेड)** | आफ्नो Hashlock अडिटपछि mainnet मा पहिलो smart contract | **`matsuri-buyback`** — व्यवसाय राजस्व → स्वचालित MTC buy-back |
| **चरण 3 (Grand Unlock, 2027-06-01)** | 550M पूल सक्रिय हुन्छ | **`matsuri-vesting`** — 550M खनन पूलको halving-release (`matsuri-distribution` सँग); DAO शासन सुरु |
| **चरण 4 (पछि, प्रत्येक अडिट-गेटेड)** | mainnet मा mining contracts | रेफरल कमिशन, साहसिक-खनन पुरस्कार, Omikuji ड्र, oracle-आधारित मिडिया खनन |
| **चरण 5 (2027+)** | सह-सिर्जना अर्थतन्त्र | अन-चेन मार्केटप्लेस (क्षेत्रीय विशेष पसल + GCF स्टोर), NFT अधिकारसहित क्राउडफन्डिङ, निर्माता + समुदाय + buyback मा स्वचालित राजस्व साझेदारी |
...
- **चरणबद्ध अडिट (Hashlock):** Phase 1 ले `matsuri-buyback` अडिट गर्छ (2026); Phase 1.5 ले `matsuri-vesting` + `matsuri-distribution` अडिट गर्छ (लगभग 2027-06-01 unlock को समयमा)। कन्ट्र्याक्टहरू आफ्नो अडिट पास गरेपछि मात्र, एक-एक गरेर mainnet मा तैनाथ गरिन्छन्
