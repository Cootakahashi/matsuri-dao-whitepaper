...
![Tre produkter som spiller ett økosystem sammen](/brand/05b_B_triptych.webp)
...
```mermaid
graph TD
    A["🤝 GCF — internasjonal fellesskap"] -->|Arrangerer events| B["⛩️ Matsuri — kulturopplevelses-app"]
    A -->|Publiserer innhold| C["📰 J-Times — japansk kulturmedium"]
    B --> D["🪙 Tjen og bruk MTC"]
    C --> D
    D -->|Sirkulerer i økonomien| A
```
