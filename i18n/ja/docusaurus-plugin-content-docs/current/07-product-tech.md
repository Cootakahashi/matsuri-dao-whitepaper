...
Webアプリ・管理ダッシュボードは**本番運用中**。3つのネイティブiOSアプリは開発完了し2026年4月にリリース予定。Solana上のスマートコントラクトはオープンソースで公開済み——構想ではなく、**動いているコードと、まもなく届くプロダクト**で語ります。
...
| **Matsuri** | 一般ユーザー向けメインアプリ | 🔜 2026年4月リリース | 🇯🇵🇬🇧🇨🇳🇹🇭🇳🇴 |
| **J-Times** | カルチャーメディア＆学習 | 🔜 2026年4月リリース | 🇯🇵🇬🇧 |
