...
**Matsuri အက်ပ်** ကို ဖွင့်ပြီး အထွဋ်အမြတ် နေရာများ မြေပုံပေါ်တွင် ဘုရားကျောင်း သို့မဟုတ် ဘုန်းကြီးကျောင်းတစ်ခု ရှာဖွေပြီး သွားရောက်ကာ check-in လုပ်ပါ။ လူနည်းသော နေရာလေ ပိုရလေ ဖြစ်သည်။
...
sequenceDiagram
    ...
    API->>API: တည်နေရာ အတည်ပြုခြင်း (နေရာမှ 200m အတွင်း)
    API->>API: ဆုကြေး တွက်ချက်ခြင်း (အလွှာ ၆ ခု ပုံသေနည်း)
    API-->>U: ဆုကြေး ပြသခြင်း: "⛩️ +150 MTC" + Omikuji ဖွင့်ခြင်း
    U->>API: Omikuji ဖွင့်ခြင်း
    API-->>U: "🏆 大吉! ×3.0 ဆုကြေး → စုစုပေါင်း 450 MTC"
    API->>SC: Solana သို့ တင်သွင်းခြင်း (async, သြဂုတ်နောက်ပိုင်း)
```

**ဆုကြေး မြှောက်ကိန်း — ကျေးလက်က ဘာကြောင့် ပိုရသလဲ:**

| နေရာ အမျိုးအစား | ဥပမာများ | မြှောက်ကိန်း |
| :--- | :--- | :---: |
| 🏙️ **အဓိက** | Sensoji, Kiyomizu-dera, Fushimi Inari | ×1 |
| 🌆 **ဒေသဆိုင်ရာ** | ခရိုင် ichinomiya၊ ဒေသဆိုင်ရာ ဘုရားကျောင်းကြီးများ | ×2 |
| 🏞️ **ကျေးလက်** | သမိုင်းဝင် ကျေးလက် ဘုရားကျောင်းများ | ×5 |
| ⛰️ **နယ်စပ်** | တောင်ပေါ် ဘုန်းကြီးကျောင်းများ၊ ဝေးလံသော ကျွန်း အထွဋ်အမြတ် နေရာများ | ×10 |

**ထပ်ဆောင်း ဆုကြေးများ:**
- **ရှေ့ဆောင် ဆုကြေး** — ထိုနေ့၏ ပထမဆုံး ဝင်ရောက်သူက အများဆုံးရရှိသည် (harmonic decay)
- **ဆက်တိုက် ဆုကြေး** — ဆက်တိုက် ရက်များ သွားရောက်ပါက +50% အထိ
- **Omikuji** — ကျပန်း ကံစမ်းမှု: 大吉 = ×3.0, 吉 = ×1.5, 小吉 = ×1.2
- **ကိုယ်စားပြု Beacons** — မြို့နယ်အစိုးရများက သတ်မှတ်နေရာများ မြှင့်တင်ရန် MTC အပ်နှံထားသည်

> **ဥပမာ:** ဝေးလံသော တောင်ပေါ် ဘုရားကျောင်း (×10) သို့ ထိုနေ့၏ ဒုတိယမြောက် ဝင်ရောက်သူအနေဖြင့် သွားရောက်ပြီး ၅ ရက်ဆက်တိုက် (+10%) နှင့် 吉 (×1.5) ဖွင့်ရရှိပါက = အခြေခံ ဆုကြေး **16.5 ဆ** မြှောက်မည်။
...
```
သင့်ရမှတ် = (တိုက်ရိုက် မိတ်ဆက်မှုများ × 30%) + (ကွန်ရက် ငွေကြေးလွှဲပြောင်းမှု ပမာဏ × 70%)
            × Toku Staking မြှောက်ကိန်း (1.0× – 10.0×)
            × ဘွဲ့တံဆိပ် တိုးမြှင့်ချက် (+5% ဆီဇင်တိုင်း၊ အများဆုံး +50%)
```

> **အဓိက အချက်:** သင့်ရမှတ်၏ 70% သည် သင့်ကွန်ရက်ရှိ **အမှန်တကယ် စီးပွားရေး လုပ်ဆောင်ချက်** မှ လာသည်၊ စာရင်းသွင်းခြင်းများမှ မဟုတ်။ ဘယ်တော့မှ မသုံးစွဲသော လူ ၁,၀၀၀ ကို ဖိတ်ခေါ်ခြင်းသည် တက်ကြွစွာ သုံးစွဲသူ ၁၀ ဦးကို ဖိတ်ခေါ်ခြင်းထက် နည်းရသည်။
...
| အချက် | အသေးစိတ် |
| :--- | :--- |
| **ပစ်မှတ် APY** | 50% (အစောပိုင်း ငွေကြေးအရည်ပါယ် မက်လုံး) |
| **DEX** | Raydium (Solana) |
| **ဘယ်သူ** | MTC နှင့် SOL ကိုင်ဆောင်ထားသူ မည်သူမဆို |

---

### 6. 🎲 Omikuji ဆုကြေး — ကံကောင်းခြင်း မြှောက်ကိန်း

စွန့်စားခရီး Mining check-in တိုင်းတွင် အခမဲ့ Omikuji (ကံစမ်း) ဖွင့်ခြင်း ပါဝင်သည်။ ဤမြှောက်ကိန်းသည် အခြား ဆုကြေးအားလုံး အပေါ်မှ ထပ်ဆင့် အသုံးပြုသည်။

| ကံကြမ္မာ | ဖြစ်နိုင်ခြေ | မြှောက်ကိန်း |
| :--- | :---: | :---: |
| 🏆 **大吉** (မဟာ ကောင်းချီး) | 5% | ×3.0 |
| ✨ **吉** (ကောင်းချီး) | 15% | ×1.5 |
| 🌸 **小吉** (ကောင်းချီးငယ်) | 30% | ×1.2 |
| 🍃 **末吉** (အနာဂတ် ကောင်းချီး) | 35% | ×1.0 |
| 💀 **凶** (ကံဆိုး) | 15% | ×1.0 |

ရလဒ်ကို Solana ရှိ **ပြုပြင်မရနိုင်သော commit-reveal protocol** ဖြင့် ဆုံးဖြတ်သည်။ commit အဆင့်ပြီးနောက် server ကိုယ်တိုင်ပင် သင့်ရလဒ်ကို ပြောင်းလဲ၍ မရပါ။
...
| **📈 Toku Staking** | MTC ကို lock ချပြီး mining မြှောက်ကိန်းကို မြှင့်တင်ပါ (1.0× → 10.0×) | 🔜 သြဂုတ် 2026 |
