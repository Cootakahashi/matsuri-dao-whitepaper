...
افتح تطبيق **Matsuri**، وابحث عن ضريح أو معبد على خريطة المواقع المقدسة، واذهب إليه وسجّل زيارتك. كلما كان الموقع أقل زيارة، كلما كسبت أكثر.
...
sequenceDiagram
    ...
    API->>API: التحقق من الموقع (ضمن 200 متر من الموقع)
    API->>API: حساب المكافأة (صيغة من 6 طبقات)
    API-->>U: عرض المكافأة: «⛩️ +150 MTC» + سحب Omikuji
    U->>API: سحب Omikuji
    API-->>U: «🏆 大吉! مكافأة ×3.0 ← 450 MTC إجمالاً»
    API->>SC: الإرسال إلى Solana (غير متزامن، بعد أغسطس)
```

**مُضاعفات المكافأة — لماذا تدفع المناطق الريفية أكثر:**

| نوع الموقع | أمثلة | المُضاعف |
| :--- | :--- | :---: |
| 🏙️ **رئيسي** | Sensoji، Kiyomizu-dera، Fushimi Inari | ×1 |
| 🌆 **إقليمي** | إيتشينوميا المحافظات، الأضرحة الكبرى الإقليمية | ×2 |
| 🏞️ **ريفي** | الأضرحة التاريخية في الريف | ×5 |
| ⛰️ **حدودي** | معابد جبلية، مواقع مقدسة في جزر نائية | ×10 |

**بالإضافة إلى مكافآت إضافية:**
- **مكافأة الرائد** — أول زائر في اليوم يكسب الأكثر (تناقص توافقي)
- **مكافأة السلسلة** — زُر أيامًا متتالية للحصول على ما يصل إلى +50%
- **Omikuji** — سحب حظ عشوائي: 大吉 = ×3.0، 吉 = ×1.5، 小吉 = ×1.2
- **المنارات المُموَّلة** — تودع البلديات MTC لتعزيز مواقع محددة

> **مثال:** زُر ضريحًا جبليًا نائيًا (×10) كثاني زائر في اليوم، مع سلسلة 5 أيام (+10%)، واسحب 吉 (×1.5) = المكافأة الأساسية مُضخَّمة بمقدار **16.5×**.
...
**كيف تعمل نتيجة En-Mining:**

```
نتيجتك = (الإحالات المباشرة × 30%) + (حجم معاملات الشبكة × 70%)
         × مُضاعف Toku Staking (1.0× – 10.0×)
         × تعزيز اللقب (+5% لكل موسم مُصنَّف، بحد أقصى +50%)
```

> **ملاحظة رئيسية:** 70% من نتيجتك تأتي من **النشاط الاقتصادي الحقيقي** في شبكتك، وليس مجرد التسجيلات. دعوة 1,000 شخص لا ينفقون أبدًا تكسب أقل من دعوة 10 مُنفقين نشطين.
...
| العنصر | التفاصيل |
| :--- | :--- |
| **العائد السنوي المستهدف** | 50% (حافز سيولة مبكر) |
| **المنصة** | Raydium (Solana) |
| **من يمكنه المشاركة** | أي شخص يحمل MTC و SOL |

---

### 6. 🎲 مكافأة Omikuji — مُضاعف الحظ

يتضمن كل تسجيل في Adventure Mining سحب Omikuji (حظ) مجاني. يُطبَّق هذا المُضاعف فوق جميع المكافآت الأخرى.

| الحظ | الاحتمال | المُضاعف |
| :--- | :---: | :---: |
| 🏆 **大吉** (بركة عظيمة) | 5% | ×3.0 |
| ✨ **吉** (بركة) | 15% | ×1.5 |
| 🌸 **小吉** (بركة صغيرة) | 30% | ×1.2 |
| 🍃 **末吉** (بركة مستقبلية) | 35% | ×1.0 |
| 💀 **凶** (نحس) | 15% | ×1.0 |

تُحدَّد النتيجة بواسطة **بروتوكول commit-reveal مقاوم للتلاعب** على Solana. حتى الخادم لا يمكنه تغيير نتيجتك بعد مرحلة الالتزام.
...
| **📈 Toku Staking** | قفل MTC لتعزيز مُضاعف التعدين الخاص بك (1.0× → 10.0×) | 🔜 أغسطس 2026 |
