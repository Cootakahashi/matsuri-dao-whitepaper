...
<div className="mtc-alloc">
  <div className="mtc-alloc__donut" role="img" aria-label="توزيع MTC: Mining Pool 61%, تشغيل النظام البيئي 39%">
...
:::info العقد الذي ينفّذ هذا
عند فتح 2027-06-01، يتدفّق مجمع الـ550M من قفل **Streamflow** الخارجي إلى عقد **`matsuri-vesting`** الذكي، الذي ينفّذ الإطلاق النصفي on-chain. `matsuri-vesting` جزء من تدقيق **Hashlock** المتدرّج (المرحلة 1.5)، إلى جانب `matsuri-distribution`. أول عقد يُطرح هو `matsuri-buyback` (المرحلة 1، 2026).
:::
