...
Webplattformen kjører. iOS-apper (Matsuri, J-Times) utgis april 2026. Vi fokuserer på inntjening og tidlig likviditet via et finanssystem direkte under CEO.
...
graph LR
    subgraph "Skapere"
        S1["🏺 Lokale håndverkere\ntradisjonelt håndverk"]
        S2["🍵 Lokale produsenter\nregionale spesialiteter"]
        S3["🎌 GCF-partnere\nkurerte opplevelser"]
    end
    subgraph "On-chain-betaling"
        SC["⚡ Smart contract\nautomatisk inntektsfordeling"]
    end
    subgraph "Verdifordeling"
        V1["💎 MTC-tilbakekjøp\n(% av omsetning)"]
        V2["🏘️ Community-fond\n(reinvestering i lokalområdet)"]
        V3["👤 Skaper-inntekt\n(direkte utbetaling)"]
    end
    S1 & S2 & S3 --> SC
    SC --> V1 & V2 & V3
...
| Punkt | Detaljer |
| :--- | :--- |
| **Rolle** | Leder av GCF-fellesskapet. Utformer driften av events og turer, leder felten |
...
![Arv mellom generasjoner ── gammel visdom rukket videre til framtiden](/brand/11_B_generational_handoff.webp)
...
![Framtidsvisjon ── Matsuri-økonomien sprer seg over verden](/brand/11_A_future_vista.webp)
