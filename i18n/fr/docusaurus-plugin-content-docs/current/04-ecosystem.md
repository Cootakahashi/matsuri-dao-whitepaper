...
![Les 3 piliers du mining — l'action humaine génère de l'or numérique](/production/04-ecosystem_mining-pillars_labeled.jpg)
...
![Suite mobile — gérez tout depuis votre smartphone](/production/04-ecosystem_mobile-suite_dashboard-center.jpg)
...
```mermaid
graph LR
    subgraph "Conception des récompenses"
    A["🏯 Sites populaires (ex : Asakusa)"] -->|Rendement faible| C["⚖️ Dispersion des foules"]
    B["⛩️ Trésors cachés (temples ruraux)"] -->|Rendement ultra-élevé| C
    end
    C --> D["🌱 Revitalisation régionale"]
```
