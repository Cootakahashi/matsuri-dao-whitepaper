...
sidebar_position: 7
id: roadmap
title: 🗓️ Plan razvoja i tim
description: "Trofazni plan razvoja od ¥1B do ¥10B AUM, postupna tranzicija na DAO i tim koji gradi japanski kulturni OS."
---
...
graph LR
    subgraph "Kreatori"
        ...
        S2["🍵 Regionalni proizvođači\nLokalne specijalitete"]
        S3["🎌 GCF partneri\nKurirani doživljaji"]
    end
    subgraph "Poravnanje na lancu"
        SC["⚡ Pametni ugovor\nAutomatska podjela prihoda"]
    end
    subgraph "Raspodjela vrijednosti"
        V1["💎 Otkup MTC-a\n(% svake prodaje)"]
        V2["🏘️ Fond zajednice\n(Lokalno reinvestiranje)"]
        V3["👤 Prihod kreatora\n(Izravna isplata)"]
    end
    S1 & S2 & S3 --> SC
    SC --> V1 & V2 & V3
...
![Vizija osnivača — stajanje na mostu između kulture i tehnologije](/production/05-roadmap_founder-vision_bridge.jpeg)
...
![Vizija budućnosti — Matsuri ekonomija širi se diljem svijeta](/production/05-roadmap_future-vision_global-adoption.jpg)
