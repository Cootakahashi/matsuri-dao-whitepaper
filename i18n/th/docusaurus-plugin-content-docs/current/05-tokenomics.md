...
<div className="mtc-alloc">
  <div className="mtc-alloc__donut" role="img" aria-label="MTC Allocation: Mining Pool 61%, การดำเนินงานระบบนิเวศ 39%">
...
:::info สัญญาใดที่ทำสิ่งนี้
ที่การ unlock 2027-06-01 พูล 550M จะไหลจากการล็อกของบุคคลที่สาม **Streamflow** เข้าสู่ Smart Contract **`matsuri-vesting`** ซึ่งดำเนินการปล่อยแบบ halving บน on-chain `matsuri-vesting` เป็นส่วนหนึ่งของการตรวจสอบแบบเป็นขั้น **Hashlock** (Phase 1.5) ร่วมกับ `matsuri-distribution` สัญญาแรกที่ขึ้นตัวจริงคือ `matsuri-buyback` (Phase 1, 2026)
:::
