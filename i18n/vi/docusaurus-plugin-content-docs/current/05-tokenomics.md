...
| **Cộng đồng GCF** | Đang trong quá trình tham gia |
...
<div style={{display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap', margin: '2.5rem 0 1rem'}}>
  <img src="/img/apps/matsuri-payment-methods.webp" alt="Thanh toán Matsuri — trả bằng thẻ, số dư MTC hoặc crypto (SOL/MTC)" style={{width: '100%', maxWidth: '204px', borderRadius: '16px', border: '1px solid rgba(167,139,250,0.2)', boxShadow: '0 8px 28px rgba(0,0,0,0.25)'}} />
  <img src="/img/apps/matsuri-mypage-rewards.webp" alt="Một ví Matsuri thực — số dư MTC và phần thưởng tích lũy" style={{width: '100%', maxWidth: '204px', borderRadius: '16px', border: '1px solid rgba(167,139,250,0.2)', boxShadow: '0 8px 28px rgba(0,0,0,0.25)'}} />
</div>

*MTC đã có thể tiêu được, không phải lời hứa vào lúc nào đó: khi thanh toán bạn có thể chi trả bằng số dư MTC hoặc crypto on-chain, và một ví thực hiển thị phần thưởng tích lũy bên cạnh số dư MTC.*
