...
> ⚠️ **स्थिति नोट।** तल देखाइएका तीन प्रोग्रामहरू protocol को **Phase 2 design
> reference** हुन् र **अहिलेसम्म mainnet मा तैनाथ भएका छैनन्**। अन-चेन सुरक्षा काम एक
> **चरणबद्ध अडिट** (Hashlock) को रूपमा अघि बढ्छ: Phase 1 ले `matsuri-buyback` अडिट गर्छ;
> Phase 1.5 ले `matsuri-vesting` + `matsuri-distribution` अडिट गर्छ। यो आरेखले लक्षित
> आर्किटेक्चर वर्णन गर्छ, हालको तैनाथी अवस्था होइन।

Matsuri को design Solana मा **तीन Anchor (Rust) प्रोग्रामहरू** बाट बनेको छ, प्रत्येकले इकोसिस्टमको स्तम्भहरू मध्ये एक बोक्छ (Phase 2 design reference — अहिलेसम्म तैनाथ भएको छैन)।
