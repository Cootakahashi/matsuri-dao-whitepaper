...
![Un solo ecosistema, suonato a tre voci](/brand/05b_B_triptych.webp)
...
```mermaid
graph TD
    A["🤝 GCF — community internazionale"] -->|Pianifica eventi| B["⛩️ Matsuri — app di esperienze culturali"]
    A -->|Pubblica contenuti| C["📰 J-Times — media di cultura giapponese"]
    B --> D["🪙 Guadagna e spendi MTC"]
    C --> D
    D -->|Circola attraverso l'economia| A
```
