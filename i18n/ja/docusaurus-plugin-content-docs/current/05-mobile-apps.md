...
>**3つのネイティブiOSアプリが、Matsuriエコシステムの全レイヤーをカバー。**
> すべてSwift 6 / iOS 17+で構築。共通基盤ライブラリ「JCCore」により、認証・ネットワーク・デザインを統一。
...
| **Matsuri** | 一般ユーザー向けメインアプリ | 🔜 4月後半リリース | 🇯🇵🇬🇧🇨🇳🇹🇭🇳🇴 |
| **J-Times** | カルチャーメディア＆学習 | 🔜 4月後半リリース | 🇯🇵🇬🇧 |
...
**[▶ 次: ロードマップ & チーム](/docs/roadmap)**｜**[◀ 前: エコシステム & マイニング](/docs/ecosystem)**
