...
<div style={{display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap', margin: '2rem 0'}}>
  <img src={useBaseUrl("/img/apps/gcf-dashboard.webp")} alt="GCF Admin 대시보드" style={{width: '100%', maxWidth: '200px', borderRadius: '16px', border: '1px solid rgba(167,139,250,0.2)'}} />
  <img src={useBaseUrl("/img/apps/gcf-members.webp")} alt="GCF Admin 관리 도구" style={{width: '100%', maxWidth: '200px', borderRadius: '16px', border: '1px solid rgba(167,139,250,0.2)'}} />
  <img src={useBaseUrl("/img/apps/gcf-revenue.webp")} alt="GCF Admin 액티비티" style={{width: '100%', maxWidth: '200px', borderRadius: '16px', border: '1px solid rgba(167,139,250,0.2)'}} />
</div>
...
:::info 상태: App Store 출시 완료 (v3.0)
일반 유저용 메인 앱. 이벤트 예약, 결제, Web3 지갑, AR 마이닝까지, 모든 것을 하나의 앱으로 완결. **App Store에서 다운로드할 수 있습니다.**
:::
...
<div style={{display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap', margin: '2rem 0'}}>
  <img src={useBaseUrl("/img/apps/matsuri-home.webp")} alt="Matsuri 홈 화면" style={{width: '100%', maxWidth: '200px', borderRadius: '16px', border: '1px solid rgba(167,139,250,0.2)'}} />
  <img src={useBaseUrl("/img/apps/matsuri-wallet.webp")} alt="Matsuri 이벤트 상세" style={{width: '100%', maxWidth: '200px', borderRadius: '16px', border: '1px solid rgba(167,139,250,0.2)'}} />
  <img src={useBaseUrl("/img/apps/matsuri-sacred-map.webp")} alt="Matsuri 성지 맵" style={{width: '100%', maxWidth: '200px', borderRadius: '16px', border: '1px solid rgba(167,139,250,0.2)'}} />
</div>
...
> ⚠️ **상태 주석.** 아래에 표시된 3개의 프로그램은 프로토콜의 **페이즈 2 설계
> 레퍼런스**이며, **아직 메인넷에 배포되지 않았습니다**. 온체인 보안 작업은
> **단계적 감사**(Hashlock)로 진행됩니다: 페이즈 1에서 `matsuri-buyback` 을 감사(2026년 8월); 페이즈 1.5에서
> `matsuri-vesting` ＋ `matsuri-distribution` 을 감사(2027년 Q1). 이 다이어그램은 목표로 하는
> 아키텍처를 나타내며, 현재의 배포 상태가 아닙니다.

Matsuri의 설계는 에코시스템의 각 기둥을 담당하는 Solana 위의 **3개의 Anchor(Rust) 프로그램**으로 구성됩니다(페이즈 2 설계 레퍼런스——아직 배포되지 않음).
