...
เปิด **แอป Matsuri** ค้นหาศาลเจ้าหรือวัดบนแผนที่สถานที่ศักดิ์สิทธิ์ ไปที่นั่น และเช็คอิน กิจกรรมของคุณจะถูกบันทึกเป็น **คะแนนการมีส่วนร่วม**
...
sequenceDiagram
    ...
    API->>API: ตรวจสอบตำแหน่ง + บันทึกคะแนนการมีส่วนร่วม
    API-->>U: แสดงผลลัพธ์: "⛩️ เช็คอินเรียบร้อย!" + จับ Omikuji
    U->>API: จับ Omikuji
    API-->>U: "🏆 大吉! คะแนนโบนัส!"
    API->>SC: ส่งไปยัง Solana (แบบอะซิงค์, หลัง ส.ค.)
```

**หลักการพื้นฐาน — สถานที่ที่มีผู้เยี่ยมชมน้อยได้คะแนนมากกว่า:**

| ประเภทสถานที่ | ตัวอย่าง | คะแนน |
| :--- | :--- | :---: |
| 🏙️ **หลัก** | Sensoji, Kiyomizu-dera, Fushimi Inari | มาตรฐาน |
| 🌆 **ภูมิภาค** | อิชิโนมิยะประจำจังหวัด, ศาลเจ้าใหญ่ประจำภูมิภาค | สูงกว่า |
| 🏞️ **ชนบท** | ศาลเจ้าประวัติศาสตร์ในชนบท | สูงกว่ามาก |
| ⛰️ **แนวหน้า** | วัดบนภูเขา, สถานที่ศักดิ์สิทธิ์บนเกาะห่างไกล | สูงสุด |

**ปัจจัยคะแนนเพิ่มเติม:**
- **ความถี่ในการเยี่ยมชม** — ผู้เยี่ยมชมประจำได้รับมากขึ้นเมื่อเวลาผ่านไป
- **Omikuji** — จับฉลากโชคชะตาแบบสุ่มเพิ่มคะแนนโบนัส (大吉 ดีที่สุด!)
- **สถานที่ที่ได้รับการสนับสนุน** — เทศบาลสามารถส่งเสริมสถานที่เฉพาะได้

:::info คะแนนการมีส่วนร่วม → MTC
กิจกรรมของคุณสะสมเป็น **คะแนนการมีส่วนร่วม** ในแต่ละยุค halving (เริ่มมิถุนายน 2027) คะแนนจะถูกแปลงเป็น MTC จากพูลการขุด 550M ยิ่งคุณมีส่วนร่วมมากเมื่อเทียบกับชุมชน ยิ่งได้รับ MTC มากขึ้น ค่าสัมประสิทธิ์โบนัสที่แน่นอนจะถูกกำหนดอย่างค่อยเป็นค่อยไปและนำไปใช้ในสมาร์ทคอนแทร็กต์ — รับประกันการกระจายที่ยุติธรรมสอดคล้องกับขนาดพูลจริง
:::
...
คะแนนการมีส่วนร่วมของคุณคำนวณจากสองปัจจัย:
- **การเข้าถึงเครือข่าย** (30%) — คุณพาคนเข้ามาเท่าไหร่
- **กิจกรรมทางเศรษฐกิจ** (70%) — การซื้อจริงจากเครือข่ายแนะนำของคุณ

> **ข้อมูลสำคัญ:** ส่วนใหญ่ของคะแนนมาจาก **กิจกรรมทางเศรษฐกิจจริง** ในเครือข่ายของคุณ ไม่ใช่แค่การสมัคร การเชิญ 1,000 คนที่ไม่เคยใช้จ่ายจะได้น้อยกว่าการเชิญ 10 คนที่ใช้จ่ายจริง

คะแนนสะสมเมื่อเวลาผ่านไปและแปลงเป็น MTC ในแต่ละยุค halving ตัวคูณส่งเสริม (เช่น การ staking MTC, การจัดอันดับตามฤดูกาล) จะถูกแนะนำอย่างค่อยเป็นค่อยไปผ่านสมาร์ทคอนแทร็กต์
...
| รายการ | รายละเอียด |
| :--- | :--- |
| **APY เป้าหมาย** | 20% (สิ่งจูงใจสภาพคล่องช่วงแรก) |
| **DEX** | Raydium (Solana) |
| **ใคร** | ทุกคนที่ถือ MTC และ SOL |

---

### 6. 🎲 โบนัส Omikuji — จับฉลากโชคชะตา

ทุกการเช็คอินจากการขุดจากการผจญภัยรวมการจับ Omikuji (ดวง) ฟรี — โบนัสเพิ่มเติมจากคะแนนปกติของคุณ

| ดวง | ความหายาก | โบนัส |
| :--- | :---: | :--- |
| 🏆 **大吉** (มหาโชค) | หายาก | คะแนนโบนัสสูงสุด + NFT |
| ✨ **吉** (โชคดี) | ไม่ค่อยพบ | คะแนนโบนัสดี |
| 🌸 **小吉** (โชคเล็กน้อย) | ทั่วไป | โบนัสเล็กน้อย |
| 🍃 **末吉** (โชคในอนาคต) | ทั่วไป | บันทึกการเข้าร่วม |
| 💀 **凶** (โชคร้าย) | ไม่ค่อยพบ | บันทึกการเข้าร่วม |

ผลลัพธ์ถูกกำหนดโดย **โปรโตคอล commit-reveal ที่ป้องกันการแทรกแซง** บน Solana แม้แต่เซิร์ฟเวอร์ก็ไม่สามารถเปลี่ยนผลลัพธ์ของคุณหลังจากเฟส commit ความน่าจะเป็นที่แน่นอนและจำนวนโบนัสจะถูกกำหนดในการนำสมาร์ทคอนแทร็กต์ไปใช้
...
| **📈 Staking Toku** | ล็อค MTC เพื่อเพิ่มคะแนนการมีส่วนร่วมของคุณ (เพิ่มได้สูงสุด ~50%) | 🔜 ส.ค. 2026 |
