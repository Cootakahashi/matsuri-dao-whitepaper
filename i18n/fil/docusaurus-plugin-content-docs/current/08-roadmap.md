...
graph LR
    subgraph "Creator"
        S1["🏺 Local artisan\nTraditional crafts"]
        S2["🍵 Regional producer\nLocal specialties"]
        S3["🎌 GCF Partner\nCurated experience"]
    end
    subgraph "On-chain Payment"
        SC["⚡ Smart Contract\nAutomatic revenue distribution"]
    end
    subgraph "Value Distribution"
        V1["💎 MTC Buyback\n(% ng sales)"]
        V2["🏘️ Community Fund\n(reinvestment sa region)"]
        V3["👤 Creator Revenue\n(direct payment)"]
    end
    S1 & S2 & S3 --> SC
    SC --> V1 & V2 & V3
...
| Item | Detalye |
| :--- | :--- |
| **Papel** | GCF operations. Operational design at field work ng events at tours |
...
![Pagpasa sa pagitan ng henerasyon ── paghahatid ng sinaunang karunungan sa hinaharap](/brand/11_B_generational_handoff.webp)
...
![Future vision ── Matsuri economic zone na lumalawak sa buong mundo](/brand/11_A_future_vista.webp)
