...
```mermaid
graph TD
    A["🤝 GCF — komunitas internasional"] -->|Rencanakan acara| B["⛩️ Matsuri — aplikasi pengalaman budaya"]
    A -->|Terbitkan konten| C["📰 J-Times — media budaya Jepang"]
    B --> D["🪙 Hasilkan dan belanjakan MTC"]
    C --> D
