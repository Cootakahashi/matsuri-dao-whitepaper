...
graph LR
    subgraph "Kreatori"
        ...
        S2["🍵 Lokalni proizvođači\nregionalne posebnosti"]
        S3["🎌 GCF partneri\nkurirana iskustva"]
    end
    subgraph "On-chain plaćanje"
        SC["⚡ Pametni ugovor\nautomatska raspodjela prihoda"]
    end
    subgraph "Raspodjela vrijednosti"
        V1["💎 MTC buyback\n(% prihoda)"]
        V2["🏘️ Community fond\n(reinvestiranje u zajednicu)"]
        V3["👤 Prihod kreatora\n(izravna isplata)"]
    end
    S1 & S2 & S3 --> SC
    SC --> V1 & V2 & V3
...
![Nasljeđe kroz generacije ── drevna mudrost predaje se budućnosti](/brand/11_B_generational_handoff.webp)
...
![Vizija budućnosti ── Matsuri ekonomija širi se cijelim svijetom](/brand/11_A_future_vista.webp)
