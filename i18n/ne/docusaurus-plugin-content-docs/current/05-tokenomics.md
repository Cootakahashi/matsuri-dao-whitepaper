...
| **GCF समुदाय** | जोड्ने प्रक्रिया जारी |
...
:::info यो कुन contract ले गर्छ
2027-06-01 unlock मा 550M पूल तेस्रो-पक्ष **Streamflow** lockup बाट **`matsuri-vesting`** smart contract मा बग्छ, जसले halving release अन-चेन कार्यान्वयन गर्छ। `matsuri-vesting` चरणबद्ध **Hashlock** अडिट (Phase 1.5) को भाग हो, `matsuri-distribution` सँगै। तैनाथ हुने पहिलो contract `matsuri-buyback` हो (Phase 1, 2026)।
:::
