...
![Ang 3 Haligi ng Mining — ang aksyon ng tao ay gumagawa ng digital gold](/production/04-ecosystem_mining-pillars_labeled.jpg)
...
![Mobile Suite — pamahalaan ang lahat mula sa iyong phone](/production/04-ecosystem_mobile-suite_dashboard-center.jpg)
...
graph LR
    ...
    A["🏯 Mga Sikat na Lugar (hal. Asakusa)"] -->|Mababang Yield| C["⚖️ Crowd Dispersal"]
    B["⛩️ Mga Nakatagong Yaman (Rural Shrines)"] -->|Ultra-High Yield| C
    end
    C --> D["🌱 Regional Revitalisation"]
```
