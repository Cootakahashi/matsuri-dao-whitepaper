...
منصة الويب تعمل، وأصبحت جميع تطبيقات iOS الثلاثة (GCF Admin، J-Times، Matsuri) متوفرة الآن على App Store (حتى أبريل 2026). نركّز على التحقيق من خلال النظام المالي تحت إشراف الرئيس التنفيذي مباشرة، وتأمين السيولة الأولية.
