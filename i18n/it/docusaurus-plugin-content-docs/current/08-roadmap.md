...
La piattaforma web è attiva. Le app iOS (Matsuri, J-Times) sono previste in uscita ad aprile 2026. Ci concentriamo sulla monetizzazione attraverso un sistema finanziario guidato dal CEO e sull'assicurare la liquidità iniziale.
...
graph LR
    subgraph "Creator"
        ...
        S2["🍵 Produttori locali\nSpecialità regionali"]
        S3["🎌 Partner GCF\nEsperienze curate"]
    end
    subgraph "Regolamento on-chain"
        SC["⚡ Smart contract\nDistribuzione automatica dei ricavi"]
    end
    subgraph "Distribuzione del valore"
        V1["💎 Buyback MTC\n(% delle vendite)"]
        V2["🏘️ Fondo della community\n(reinvestimento nel territorio)"]
        V3["👤 Ricavi del creator\n(pagamento diretto)"]
    end
    S1 & S2 & S3 --> SC
    SC --> V1 & V2 & V3
```
...
![Passaggio tra generazioni — la saggezza degli antichi, consegnata al futuro](/brand/11_B_generational_handoff.webp)
...
![Una vista del futuro — l'economia di Matsuri che si estende attraverso il mondo](/brand/11_A_future_vista.webp)
