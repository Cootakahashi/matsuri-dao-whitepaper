...
<div style={{display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap', margin: '2.5rem 0 1rem'}}>
  <img src="/img/apps/matsuri-payment-methods.webp" alt="Matsuri 결제 화면 — 카드, MTC 잔액, 또는 암호화폐(SOL/MTC)로 결제" style={{width: '100%', maxWidth: '204px', borderRadius: '16px', border: '1px solid rgba(167,139,250,0.2)', boxShadow: '0 8px 28px rgba(0,0,0,0.25)'}} />
  <img src="/img/apps/matsuri-mypage-rewards.webp" alt="가동 중인 Matsuri 지갑 — MTC 잔액과 쌓인 보상" style={{width: '100%', maxWidth: '204px', borderRadius: '16px', border: '1px solid rgba(167,139,250,0.2)', boxShadow: '0 8px 28px rgba(0,0,0,0.25)'}} />
</div>

*MTC는 '언젠가'의 약속이 아니라 이미 쓸 수 있습니다: 결제 시 MTC 잔액이나 온체인 암호화폐로 지불할 수 있고, 가동 중인 지갑이 MTC 잔액 옆에 쌓인 보상을 보여 줍니다.*
...
:::info 이 풀을 실행하는 컨트랙트
2027-06-01 언락 시, 550M 풀은 서드파티 **Streamflow** 락업에서 **`matsuri-vesting`** 스마트 컨트랙트로 흘러들어, 반감기 방출을 온체인에서 실행합니다. `matsuri-vesting` 은 `matsuri-distribution` 과 함께, 단계적 **Hashlock** 감사(페이즈 1.5)의 일부입니다. 최초로 나오는 컨트랙트는 `matsuri-buyback`(페이즈 1, 2026년)입니다.
:::
