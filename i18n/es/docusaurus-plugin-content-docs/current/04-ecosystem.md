...
![Los 3 pilares del mining — la acción humana genera oro digital](/production/04-ecosystem_mining-pillars_labeled.jpg)
...
![Suite móvil — gestiona todo desde tu smartphone](/production/04-ecosystem_mobile-suite_dashboard-center.jpg)
...
graph LR
    ...
    A["🏯 Lugares famosos (ej.: Asakusa)"] -->|Rendimiento bajo| C["⚖️ Dispersión de multitudes"]
    B["⛩️ Joyas ocultas (templos rurales)"] -->|Rendimiento ultra-alto| C
    end
    C --> D["🌱 Revitalización regional"]
```
