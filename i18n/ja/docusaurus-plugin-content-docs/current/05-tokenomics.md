...
<div className="mtc-alloc">
  <div className="mtc-alloc__donut" role="img" aria-label="MTC配分: マイニングプール61%, エコシステム運営39%">
...
<div style={{display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap', margin: '2.5rem 0 1rem'}}>
  <img src="/img/apps/matsuri-payment-methods.webp" alt="Matsuri の決済画面 — カード、MTC残高、または暗号資産(SOL/MTC)で支払い" style={{width: '100%', maxWidth: '204px', borderRadius: '16px', border: '1px solid rgba(167,139,250,0.2)', boxShadow: '0 8px 28px rgba(0,0,0,0.25)'}} />
  <img src="/img/apps/matsuri-mypage-rewards.webp" alt="稼働中の Matsuri ウォレット — MTC残高と積み上がった報酬" style={{width: '100%', maxWidth: '204px', borderRadius: '16px', border: '1px solid rgba(167,139,250,0.2)', boxShadow: '0 8px 28px rgba(0,0,0,0.25)'}} />
</div>

*MTC は「いつか」の約束ではなく、すでに使えます:決済時に MTC残高やオンチェーンの暗号資産で支払え、稼働中のウォレットが MTC残高の隣に積み上がった報酬を表示します。*
...
:::info このプールを実行するコントラクト
2027-06-01のアンロック時、550Mプールはサードパーティの **Streamflow** ロックアップから **`matsuri-vesting`** スマートコントラクトへ流れ込み、半減期放出をオンチェーンで実行します。`matsuri-vesting` は `matsuri-distribution` とともに、段階的な **Hashlock** 監査（フェーズ1.5）の一部です。最初に出るコントラクトは `matsuri-buyback`（フェーズ1、2026年）です。
:::
