...
sidebar_position: 4
id: ecosystem
title: ⛏️ Økosystem og mining
description: "Fem mining-søjler — Medier, Social, Eventyr, Skaber og Likviditet — drevet af Proof of Action. Min MTC gennem reel menneskelig aktivitet, ikke GPU'er."
---
...
![De 5 søjler af mining — menneskelig handling genererer digitalt guld](/production/04-ecosystem_mining-pillars_labeled.jpg)
...
![Mobilsuite — administrer alt fra din telefon](/production/04-ecosystem_mobile-suite_dashboard-center.jpg)
...
graph LR
    ...
    A["🏯 Berømte steder (f.eks. Asakusa)"] -->|Lavt udbytte| C["⚖️ Spredning af menneskemængder"]
    B["⛩️ Skjulte perler (landlige helligdomme)"] -->|Ultra-højt udbytte| C
    end
    C --> D["🌱 Regional revitalisering"]
```
