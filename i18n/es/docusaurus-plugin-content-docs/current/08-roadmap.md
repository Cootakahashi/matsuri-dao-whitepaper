...
graph LR
    ...
    subgraph "Pago on-chain"
        SC["⚡ Smart contract\nReparto automático"]
    end
    subgraph "Distribución del valor"
        V1["💎 Recompra MTC\n(% fijo de ventas)"]
...
![Herencia entre generaciones —— pasar la sabiduría antigua al futuro](/brand/11_B_generational_handoff.webp)
...
![Visión de futuro —— la economía Matsuri extendida por el mundo](/brand/11_A_future_vista.webp)
