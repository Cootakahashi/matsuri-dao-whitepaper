...
| **Matsuri** | แอปหลักสำหรับผู้ใช้ทั่วไป | ✅ เปิดตัวแล้ว | 🇯🇵🇬🇧🇨🇳🇹🇭🇳🇴 |
...
:::info สถานะ: เปิดตัวบน App Store แล้ว (v3.0)
แอปหลักสำหรับผู้ใช้ทั่วไป จบทุกอย่างในแอปเดียว: จองอีเวนต์, ชำระเงิน, Web3 Wallet, AR Mining **พร้อมให้ดาวน์โหลดบน App Store แล้ว**
:::
...
> ⚠️ **หมายเหตุสถานะ** โปรแกรม 3 ตัวที่แสดงด้านล่างเป็น **การออกแบบอ้างอิงของ
> Phase 2** ของโปรโตคอล และ **ยังไม่ได้ deploy ขึ้น mainnet** งานความปลอดภัย on-chain
> ดำเนินการแบบ **การตรวจสอบเป็นขั้น** (Hashlock): Phase 1 ตรวจสอบ `matsuri-buyback` (สิงหาคม 2026);
> Phase 1.5 ตรวจสอบ `matsuri-vesting` + `matsuri-distribution` (Q1 2027) แผนภาพนี้อธิบาย
> สถาปัตยกรรมเป้าหมาย ไม่ใช่สถานะการ deploy ปัจจุบัน

การออกแบบของ Matsuri ประกอบด้วย **Anchor (Rust) Program 3 ตัว** บน Solana แต่ละตัวรับผิดชอบเสาหลักของระบบนิเวศ (การออกแบบอ้างอิง Phase 2 — ยังไม่ได้ deploy)
