...
| **GCF Community** | Onboarding ဆောင်ရွက်နေသည် |
...
:::info ဤအရာကို မည်သည့် contract က လုပ်ဆောင်သနည်း
2027-06-01 unlock တွင် 550M pool သည် တတိယပါတီ **Streamflow** lockup မှ **`matsuri-vesting`** smart contract သို့ စီးဆင်းပြီး halving release ကို on-chain execute လုပ်သည်။ `matsuri-vesting` သည် အဆင့်ဆင့် **Hashlock** audit (Phase 1.5) ၏ အစိတ်အပိုင်းဖြစ်ပြီး `matsuri-distribution` နှင့်အတူ ပါဝင်သည်။ ပထမဆုံး deploy လုပ်မည့် contract မှာ `matsuri-buyback` (Phase 1, 2026) ဖြစ်သည်။
:::
