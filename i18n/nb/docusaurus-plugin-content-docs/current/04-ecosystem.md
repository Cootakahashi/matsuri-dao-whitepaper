...
![De 3 pilarene innen mining — menneskelig handling genererer digitalt gull](/production/04-ecosystem_mining-pillars_labeled.jpg)
...
![Mobilpakke — administrer alt fra telefonen din](/production/04-ecosystem_mobile-suite_dashboard-center.jpg)
...
graph LR
    ...
    A["🏯 Kjente steder (f.eks. Asakusa)"] -->|Lav avkastning| C["⚖️ Folkemengdespredning"]
    B["⛩️ Skjulte perler (landlige templer)"] -->|Ultrahøy avkastning| C
    end
    C --> D["🌱 Distriktsfornying"]
```
