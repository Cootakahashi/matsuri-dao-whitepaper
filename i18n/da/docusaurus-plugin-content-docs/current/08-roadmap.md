...
graph LR
    subgraph "Skabere"
        ...
        S2["🍵 Lokale producenter\nregionale specialiteter"]
        S3["🎌 GCF-partnere\nkurerede oplevelser"]
    end
    subgraph "On-chain-betaling"
        SC["⚡ Smart contract\nautomatisk indtægtsfordeling"]
    end
    subgraph "Værdifordeling"
        V1["💎 MTC-tilbagekøb\n(en % af omsætningen)"]
        V2["🏘️ Community-fond\n(re-investering i lokalområdet)"]
        V3["👤 Skaber-indtægt\n(direkte udbetaling)"]
    end
    S1 & S2 & S3 --> SC
    SC --> V1 & V2 & V3
...
![Arv mellem generationer ── gammel visdom rakt videre til fremtiden](/brand/11_B_generational_handoff.webp)
...
![Fremtidsvision ── Matsuri-økonomien breder sig ud over verden](/brand/11_A_future_vista.webp)
