...
sidebar_position: 4
id: ecosystem
title: ⛏️ Ekosustav i rudarenje
description: "Pet stupova rudarenja — Mediji, Društveno, Avantura, Kreatori i Likvidnost — pokretani Proof of Action mehanizmom. Rudarite MTC stvarnom ljudskom aktivnošću, ne grafičkim karticama."
---
...
![5 stupova rudarenja — ljudsko djelovanje generira digitalno zlato](/production/04-ecosystem_mining-pillars_labeled.jpg)
...
![Mobilni paket — upravljajte svime sa svog telefona](/production/04-ecosystem_mobile-suite_dashboard-center.jpg)
...
graph LR
    ...
    A["🏯 Poznata mjesta (npr. Asakusa)"] -->|Nizak prinos| C["⚖️ Raspršivanje gužve"]
    B["⛩️ Skriveni dragulji (ruralna svetišta)"] -->|Ultravisok prinos| C
    end
    C --> D["🌱 Regionalna revitalizacija"]
```
