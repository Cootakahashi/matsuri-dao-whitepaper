...
![Isang ecosystem na tinutugtog ng tatlong produkto](/brand/05b_B_triptych.webp)
...
```mermaid
graph TD
    A["🤝 GCF — International Community"] -->|Nagpaplano ng event| B["⛩️ Matsuri — Cultural Experience App"]
    A -->|Naghahatid ng content| C["📰 J-Times — Japanese Culture Media"]
    B --> D["🪙 Kumita at gumamit ng MTC"]
    C --> D
    D -->|Pag-ikot sa ecosystem| A
```
